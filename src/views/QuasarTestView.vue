    ...
    <q-page-container>
      <q-page padding>
        ...
        <q-page-sticky position="top-left" :offset="[18, 18]">
          <q-btn round color="accent" icon="mdi-arrow_back" class="rotate-45" />
        </q-page-sticky>
        <q-page-sticky position="top" :offset="[0, 18]">
          <q-btn round color="accent" icon="mdi-arrow_back" class="rotate-90" />
        </q-page-sticky>
        <q-page-sticky position="top-right" :offset="[18, 18]">
          <q-btn
            round
            color="accent"
            icon="mdi-arrow_upward"
            class="rotate-45"
          />
        </q-page-sticky>
        ...
        <q-page-sticky position="left" :offset="[18, 0]">
          <q-btn round color="accent" icon="mdi-arrow_back" />
        </q-page-sticky>
        <q-page-sticky position="bottom-left" :offset="[18, 18]">
          <q-btn
            round
            color="accent"
            icon="mdi-arrow_forward"
            class="rotate-135"
          />
        </q-page-sticky>
